...
const DB = {
    ...
    skills: [
    // ===== КОРАБЕЛЬНІ БОЙОВІ СПЕЦІАЛЬНОСТІ =====
    ...
    },
    {
        ...
        description: 'Керування кораблем, ведення курсу, сигнали і вахтове управління у морі.'
    },
    {
        id: 'boatswain',
        title: 'Боцман (такелаж / палубна команда)',
        description: 'Такелаж, швартування, якірні операції, контроль стану палубного спорядження.'
    },
    {
        id: 'marsovy',
        title: 'Марсовий',
        description: 'Спостереження за горизонтом, виявлення загроз, робота з сигнальними приладами.'
    },
    {
        id: 'komendor',
        title: 'Комендор',
        description: 'Оборона корабля, робота з озброєнням, підтримка порядку та безпеки в екіпажі.'
    },

    // ===== МАШИННО-КОТЕЛЬНИЙ / ТЕХНІЧНИЙ БЛОК =====

    {
        id: 'senior_motorist',
        title: 'Старший моторист',
        description: 'Обслуговування головної енергетичної установки, ведення журналів, контроль роботи силових агрегатів.'
    },
    {
        id: 'motorist',
        title: 'Моторист',
    ...
    // ===== КОМАНДНІ/СТАРШІ ПОСАДИ (КОМАНДИРИ ВІДДІЛЕНЬ) =====

    {
        id: 'commander_operators',
        title: 'Командир відділення операторів',
        description: 'Керівництво операторами КБУ, розподіл завдань, контроль виконання та робота з технікою.'
    },
    {
        id: 'commander_helm',
        title: 'Командир відділення рульових-сигнальників',
        description: 'Організація вахт, підготовка штурманських постів, забезпечення точного курсу корабля.'
    },
    {
        id: 'commander_komendors',
        title: 'Командир відділення комендорів',
...

    {
        ...
        description: 'Ведення спостереження, робота з РЛС та комплексами зв’язку, контроль інформаційних систем.'
    },
    {
        id: 'senior_helm',
        title: 'Старший рульовий-сигнальник',
        description: 'Керування кораблем у складних умовах, навчання молодшого складу, штурманська допомога.'
    }
]
